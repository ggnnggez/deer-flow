...
the model-visible result append a declared entry here, so observers (Ansich)
classify raw→visible transforms from facts instead of sniffing output wording.
