...
export interface Translations {
  ...
  ansich: {
    ...
    lineage: string;
    loadBackwardLineage: string;
    loadForwardLineage: string;
    loadPossibleExposures: string;
    provenanceSemantic: string;
    possibleExposureSemantic: string;
    lineageTruncated: string;
    unknownGaps: string;
    graphView: string;
    tableView: string;
    depth: string;
    ...
    behaviorMetadata: string;
    compareReleases: string;
    compareReleasesDescription: string;
    selectRelease: string;
    noReleaseChanges: string;
    budget: string;
    owner: string;
    thread: string;
