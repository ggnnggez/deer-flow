...
- Phase 5 代码评审的跟进项登记在 [phase-5-review-followups.md](phase-5-review-followups.md)；M1（assessor 全量 budget 扫描）与 M3（历史 Task 失去 UI 入口）已修复，M2（heartbeat 断言按秒膨胀）仍需在 Phase 6 前完成，L1/L2 随 M1/M2 处理，L3（usage 贡献契约收紧）留到 Phase 8 前。
