...
`tool_frequency_threshold`. Projection failures and collector/lost-range
degradation remain visible through projection health in this phase; dedicated
Alert producers and filters for those signals are deferred to the production
resilience phase.
