...
from deerflow_extension_api import BackendAction, PluginContribution, SettingsField, extension
...
def install(registry: Any, config: Mapping[str, Any]) -> None:
    ...
    if accepted is not True:
        logger.info("context-residency: this host has no plugin UI support; capture and the admin API are installed without a catalog entry")
